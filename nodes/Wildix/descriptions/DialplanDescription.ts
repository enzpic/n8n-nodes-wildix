...
export const dialplanOperations: INodeProperties[] = [
	{
		...
		options: [
			{ name: 'Add DB Value', value: 'addDbValue', action: 'Add a dialplan database value', description: 'Add a value to the dialplan database under a family/key' },
			{ name: 'Create Dialplan', value: 'createDialplan', action: 'Create a dialplan', description: 'Create a new PBX dialplan' },
			...
			{ name: 'Delete DB Family', value: 'deleteDbFamily', action: 'Delete a dialplan database family', description: 'Delete all keys in a dialplan database family' },
			{ name: 'Delete DB Key', value: 'deleteDbKey', action: 'Delete a dialplan database key', description: 'Delete a key and its value from the dialplan database' },
			{ name: 'Delete Dialplan', value: 'deleteDialplan', action: 'Delete a dialplan', description: 'Delete one or more dialplans by ID' },
			...
			{ name: 'Get DB Family Keys', value: 'getDbFamilyKeys', action: 'Get dialplan database family keys', description: 'Return all keys in a dialplan database family' },
			{ name: 'Get DB Value', value: 'getDbValue', action: 'Get a dialplan database value', description: 'Return a value from the dialplan database by family/key' },
			{ name: 'Get Dialplan', value: 'getDialplan', action: 'Get a dialplan', description: 'Return a single PBX dialplan by ID' },
			...
			{ name: 'Import Time Tables', value: 'importTimeTables', action: 'Import time tables', description: 'Import a list of time tables' },
			{ name: 'Update DB Value', value: 'updateDbValue', action: 'Update a dialplan database value', description: 'Update a value in the dialplan database by family/key' },
			{ name: 'Update Dialplan', value: 'updateDialplan', action: 'Update a dialplan', description: 'Update a PBX dialplan by ID' },
...
export const dialplanFields: INodeProperties[] = [
	...
	// ── Dialplans CRUD ─────────────────────────────────────────────────────────
	{
		...
		required: true,
		default: '',
		displayOptions: { show: { resource: ['dialplan'], operation: ['getDialplan', 'updateDialplan'] } },
		description: 'ID of the dialplan',
	},
	{
		displayName: 'Dialplan IDs',
		name: 'dialplanIds',
		type: 'string',
		required: true,
		default: '',
		placeholder: '12,13,14',
		displayOptions: { show: { resource: ['dialplan'], operation: ['deleteDialplan'] } },
		description: 'One or more dialplan IDs to delete, separated by commas',
	},
	{
		displayName: 'Name',
		name: 'dialplanName',
		...
		required: true,
		default: '',
		displayOptions: { show: { resource: ['dialplan'], operation: ['createDialplan'] } },
		description: 'Name of the dialplan',
	},
	{
		displayName: 'Additional Fields',
		name: 'createDialplanFields',
		type: 'collection',
		placeholder: 'Add Field',
		default: {},
		displayOptions: { show: { resource: ['dialplan'], operation: ['createDialplan'] } },
		options: [
			{ displayName: 'Description', name: 'description', type: 'string', default: '', description: 'Dialplan description' },
			{ displayName: 'Numbers (JSON)', name: 'numbers', type: 'json', default: '[]', description: 'Array of DialplanItemNumber objects' },
			{ displayName: 'Included Dialplans (JSON)', name: 'includedDialplans', type: 'json', default: '[]', description: 'Array of DialplanItemIncludes objects (can be empty)' },
		],
	},
	{
		displayName: 'Update Fields',
		name: 'updateDialplanFields',
		type: 'collection',
		placeholder: 'Add Field',
		default: {},
		displayOptions: { show: { resource: ['dialplan'], operation: ['updateDialplan'] } },
		options: [
			{ displayName: 'Description', name: 'description', type: 'string', default: '', description: 'Dialplan description' },
			{ displayName: 'Numbers (JSON)', name: 'numbers', type: 'json', default: '[]', description: 'Array of DialplanItemNumber objects' },
			{ displayName: 'Included Dialplans (JSON)', name: 'includedDialplans', type: 'json', default: '[]', description: 'Array of DialplanItemIncludes objects (can be empty)' },
	...
	// ── Dialplan Database (family / key) ───────────────────────────────────────
	{
		...
		displayOptions: {
			show: {
				resource: ['dialplan'],
				operation: ['getDbFamilyKeys', 'getDbValue', 'addDbValue', 'updateDbValue', 'deleteDbKey', 'deleteDbFamily'],
			},
		},
		description: 'Name of the dialplan database family',
	},
	{
		displayName: 'Key',
		name: 'dbKey',
		...
		displayOptions: {
			show: {
				resource: ['dialplan'],
				operation: ['getDbValue', 'addDbValue', 'updateDbValue', 'deleteDbKey'],
			},
		},
		description: 'Key within the dialplan database family',
	},
	{
		displayName: 'Value',
		name: 'dbValue',
		...
		required: true,
		default: '',
		displayOptions: { show: { resource: ['dialplan'], operation: ['addDbValue', 'updateDbValue'] } },
		description: 'Value to store for the family/key',
	},
	...
	// ── Import Time Tables ─────────────────────────────────────────────────────
	{
		...
		required: true,
		default: '[]',
		displayOptions: { show: { resource: ['dialplan'], operation: ['importTimeTables'] } },
		description: 'JSON array of time tables to import',
	},
];
