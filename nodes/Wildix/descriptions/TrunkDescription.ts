...
export const trunkOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			{ name: 'Create Trunk Price List', value: 'createPrice', action: 'Create a trunk price list', description: 'Create a new trunk price list (optionally upload a .csv rate file)' },
			...
			{ name: 'Delete Trunk Price List', value: 'deletePrice', action: 'Delete a trunk price list', description: 'Delete a trunk price list by ID' },
			{ name: 'Export Trunk Price List', value: 'exportPrice', action: 'Export a trunk price list', description: 'Export a trunk price list by ID' },
			...
			{ name: 'Update Trunk Price List', value: 'updatePrice', action: 'Update a trunk price list', description: 'Update a trunk price list by ID (optionally upload a .csv rate file)' },
		],
		default: 'getGroups',
	},
];
...
export const trunkFields: INodeProperties[] = [
	...
	// ── Trunk Price List ───────────────────────────────────────────────────────
	{
		...
		required: true,
		default: '',
		displayOptions: { show: { resource: ['trunk'], operation: ['updatePrice', 'exportPrice', 'deletePrice'] } },
		description: 'ID of the trunk price list',
	},
	{
		displayName: 'Name',
		name: 'priceName',
		...
		default: '',
		placeholder: 'Test',
		displayOptions: { show: { resource: ['trunk'], operation: ['createPrice', 'updatePrice'] } },
		description: 'Name of the price list',
	},
	{
		displayName: 'Binary Property',
		name: 'priceBinaryProperty',
		type: 'string',
		default: '',
		placeholder: 'data',
		displayOptions: { show: { resource: ['trunk'], operation: ['createPrice', 'updatePrice'] } },
		description: 'Name of the binary property holding the .csv rate file. Leave empty to send no file.',
	},
];
